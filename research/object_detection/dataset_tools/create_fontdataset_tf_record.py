...
r"""Convert raw font dataset to TFRecord for object_detection.

Example usage:
    python object_detection/dataset_tools/create_fontdataset_tf_record.py \
...
def main(_):
  ...
  label_map_dict = get_label_dict(data_dir)

  logging.info('Reading from font dataset.')
